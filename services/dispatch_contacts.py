...
SEED_DISPATCHER_CONTACTS: list[dict[str, Any]] = [
    ...
    _entry("Carlos IL", "Prestig Inc", "dispatch1@prestige.inc", "773-965-5396", "", 1),
    _entry("Carlos IL", "Prestige Transportation Inc", "dispatch1@prestigecalifornia.com", "708-312-1409", "215", 2),
    ...
    _entry("Carlos CA", "Prestige Transportation Inc", "dispatch4@prestigecalifornia.com", "909-302-0192", "316", 2),
    ...
    _entry("Felix", "Prestige Transportation Inc", "dispatch7@prestigecalifornia.com", "708-356-4427", "217", 2),
    ...
    _entry("Lily", "Prestige Transportation Inc", "dispatch8@prestigecalifornia.com", "909-302-0187", "310", 2),
