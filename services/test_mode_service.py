...
def _build_test_form_data() -> dict[str, object]:
    ...
    return {
        ...
        "emergency_address": "789 Emergency Ave, Fontana, CA 92335",
        "text_consent": False,
        ...
        "references": [
            {"name": "Alex Ops", "phone": "555-000-1000", "relationship": "Mentor", "city": "Fontana", "state": "CA"},
            {"name": "Jamie Dispatch", "phone": "555-000-2000", "relationship": "Colleague", "city": "Ontario", "state": "CA"},
        ],
