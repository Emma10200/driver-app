...
def _render_page_3(company) -> bool:
...
def _render_page_4(company) -> bool:
...
def _render_page_5(company) -> bool:
...
def _render_page_6(company) -> bool:
...
def _render_page_7(company) -> bool:
...
def _render_page_8(company) -> bool:
...
def _render_page_9(company) -> bool:
...
def _render_page_10(company) -> bool:
...
def _render_page_11(company) -> bool:
...
def render_remaining_page(page: int) -> bool:
    ...
    if page == 3:
        return _render_page_3(company)
    if page == 4:
        return _render_page_4(company)
    if page == 5:
        return _render_page_5(company)
    if page == 6:
        return _render_page_6(company)
    if page == 7:
        return _render_page_7(company)
    if page == 8:
        return _render_page_8(company)
    if page == 9:
        return _render_page_9(company)
    if page == 10:
        return _render_page_10(company)
    if page == 11:
        return _render_page_11(company)
